...
/*   Updated: 2024/03/23 20:33:08 by hlefevre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (index <= 3 && game.matrix.space[index] == "0")
		game.matrix.space[index] = "4";
	if (index >= 4 && game.matrix.space[index + 8] == "0")
...
{
	if (index == 8 && game.matrix.space[0] == "0")
		game.matrix.space[0] = "4";
	if (index == 9 && game.matrix.space[4] == "0")
		game.matrix.space[4] = "4";
	if (index == 10 && game.matrix.space[8] == "0")
		game.matrix.space[8] = "4";
	if (index == 11 && game.matrix.space[12] == "0")
		game.matrix.space[12] = "4";
	if (index == 12 && game.matrix.space[3] == "0")
		game.matrix.space[3] = "4";
	if (index == 13 && game.matrix.space[7] == "0")
		game.matrix.space[7] = "4";
	if (index == 14 && game.matrix.space[11] == "0")
		game.matrix.space[11] = "4";
	if (index == 15 && game.matrix.space[15] == "0")
